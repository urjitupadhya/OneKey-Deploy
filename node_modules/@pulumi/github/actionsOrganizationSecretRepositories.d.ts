...
export declare class ActionsOrganizationSecretRepositories extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActionsOrganizationSecretRepositoriesState, opts?: pulumi.CustomResourceOptions): ActionsOrganizationSecretRepositories;
    /**
