...
export declare class CodespacesSecret extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CodespacesSecretState, opts?: pulumi.CustomResourceOptions): CodespacesSecret;
    /**
     * Returns true if the given object is an instance of CodespacesSecret.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CodespacesSecret;
    /**
